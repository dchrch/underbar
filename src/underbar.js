(function() {
  ...
  _.last = function(array, n) {
    return n === undefined ? array[array.length - 1] : array.slice(-n, n && array.length);
  };
  ...
  _.extend = function(obj) {
    return _.reduce(arguments, function(res, arg) {
  ...
  _.invoke = function(collection, functionOrKey, args) {
    ...
    return _.map(collection, function(item) {
      return typeof functionOrKey === 'string' ? item[functionOrKey].apply(item, args) : functionOrKey.apply(item, args);
    });
  };
